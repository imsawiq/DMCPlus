package org.sawiq.dmcplus.client.update;
...
public final class ModrinthVersionChecker {
    private static final String MODRINTH_API = "https://api.modrinth.com/v2/project/dmcplus/version";
    private static final String MODRINTH_PAGE = "https://modrinth.com/mod/dmcplus";
    ...
    public CompletableFuture<Result> checkAsync() {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            try {
                ...
                connection.setRequestProperty("User-Agent", "dmcplus/" + this.currentVersion);
